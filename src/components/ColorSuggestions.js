          ...
          <div className="color-palette">
            <div className="color-item">
              <div 
                ...
                style={{ backgroundColor: palette.interior.primary }}
              ></div>
              <div className="color-info">
                <span className="color-name">Primary</span>
                <span className="color-code">{palette.interior.primary}</span>
              </div>
            </div>
            <div className="color-item">
              <div 
                className="color-swatch" 
                style={{ backgroundColor: palette.interior.secondary }}
              ></div>
              <div className="color-info">
                <span className="color-name">Secondary</span>
                <span className="color-code">{palette.interior.secondary}</span>
              </div>
            </div>
            <div className="color-item">
              <div 
                className="color-swatch" 
                style={{ backgroundColor: palette.interior.accent }}
              ></div>
              <div className="color-info">
                <span className="color-name">Accent</span>
                <span className="color-code">{palette.interior.accent}</span>
              </div>
            </div>
            <div className="color-item">
              <div 
                className="color-swatch" 
                style={{ backgroundColor: palette.interior.neutral }}
              ></div>
              <div className="color-info">
                <span className="color-name">Neutral</span>
                <span className="color-code">{palette.interior.neutral}</span>
              </div>
            </div>
          </div>
        ...
        <div className="color-section">
          ...
          <div className="color-palette">
            <div className="color-item">
              <div 
                className="color-swatch" 
                style={{ backgroundColor: palette.exterior.primary }}
              ></div>
              <div className="color-info">
                <span className="color-name">Primary</span>
                <span className="color-code">{palette.exterior.primary}</span>
              </div>
            </div>
            <div className="color-item">
              <div 
                className="color-swatch" 
                style={{ backgroundColor: palette.exterior.secondary }}
              ></div>
              <div className="color-info">
                <span className="color-name">Secondary</span>
                <span className="color-code">{palette.exterior.secondary}</span>
              </div>
            </div>
            <div className="color-item">
              <div 
                className="color-swatch" 
                style={{ backgroundColor: palette.exterior.accent }}
              ></div>
              <div className="color-info">
                <span className="color-name">Accent</span>
                <span className="color-code">{palette.exterior.accent}</span>
              </div>
            </div>
          </div>
